...
import beardedpenguin.tenmin.TimerDataOnDemand;
...
privileged aspect TimerIntegrationTest_Roo_IntegrationTest {
    ...
    public void TimerIntegrationTest.testCountTimers() {
        ...
        long count = beardedpenguin.tenmin.Timer.countTimers();
    ...
    public void TimerIntegrationTest.testFindTimer() {
        beardedpenguin.tenmin.Timer obj = dod.getRandomTimer();
        ...
        obj = beardedpenguin.tenmin.Timer.findTimer(id);
    ...
    public void TimerIntegrationTest.testFindAllTimers() {
        ...
        java.util.List<beardedpenguin.tenmin.Timer> result = beardedpenguin.tenmin.Timer.findAllTimers();
    ...
    public void TimerIntegrationTest.testFindTimerEntries() {
        ...
        java.util.List<beardedpenguin.tenmin.Timer> result = beardedpenguin.tenmin.Timer.findTimerEntries(0, (int) count);
    ...
    public void TimerIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyTimer(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        beardedpenguin.tenmin.Timer merged =  obj.merge();
        obj.flush();
    ...
    public void TimerIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Timer' failed to initialize correctly", dod.getRandomTimer());
        beardedpenguin.tenmin.Timer obj = dod.getNewTransientTimer(Integer.MAX_VALUE);
    ...
    public void TimerIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'Timer' with identifier '" + id + "'", beardedpenguin.tenmin.Timer.findTimer(id));
    }
